...
class ValidateForm extends Component {
  ...
  render() {
    ...
    const { empNameErr, emailIdErr} = this.state.formErrors;
  ...
  return (
    ...
    <form onSubmit={this.onSubmit}>
            <div>
              ...
              {empNameErr &&
                <div style={{ color: "white", paddingBottom: 10 }}>{empNameErr}</div>
              }
            ...
            <button type="submit" className="button_dec"  value="Submit" >Submit</button>
          </form>
          </section>
